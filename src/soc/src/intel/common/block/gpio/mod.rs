use crate::intel::{
    ...
    common::block::{
        gpio::gpio_defs::{
            PAD_CFG0_MODE_MASK, PAD_CFG0_NAFVWE_ENABLE, PAD_CFG0_PREGFRXSEL, PAD_CFG0_RESET_MASK,
            PAD_CFG0_ROUTE_IOAPIC, PAD_CFG0_ROUTE_MASK, PAD_CFG0_ROUTE_NMI, PAD_CFG0_ROUTE_SCI,
            PAD_CFG0_ROUTE_SMI, PAD_CFG0_RXINV_MASK, PAD_CFG0_RXPADSTSEL_MASK,
            PAD_CFG0_RXRAW1_MASK, PAD_CFG0_RXTENCFG_MASK, PAD_CFG0_RX_DISABLE,
            PAD_CFG0_RX_POL_INVERT, PAD_CFG0_TRIG_MASK, PAD_CFG0_TX_DISABLE, PAD_CFG0_TX_STATE,
            PAD_CFG1_IOSSTATE_MASK, PAD_CFG1_IOSTERM_MASK, PAD_CFG1_IRQ_MASK, PAD_CFG1_PULL_MASK,
            PAD_CFG2_DEBOUNCE_MASK, PAD_CFG_OWN_GPIO_DRIVER,
        },
