const GOOGLE_CHROMEEC_USBC_DEVICE_HID: &str = "GOOG0014";
const GOOGLE_CHROMEEC_USBC_DEVICE_NAME: &str = "USBC";

pub fn google_chromeec_acpi_name(dev: &Device) -> &'static str {
	/*
